...
export namespace WalletUnlocker {
  export class CreateWallet {
    ...
    static readonly requestType = rpc_pb.CreateWalletRequest;
  ...
  export class UnlockWallet {
    ...
    static readonly requestStream = false;
    static readonly responseStream = false;
    static readonly requestType = rpc_pb.UnlockWalletRequest;
    static readonly responseType = rpc_pb.UnlockWalletResponse;
  }
}
...
export namespace Lightning {
  ...
  export class PendingChannels {
    ...
    static readonly requestStream = false;
    static readonly responseStream = false;
    static readonly requestType = rpc_pb.PendingChannelsRequest;
  ...
  export class FeeReport {
    ...
    static readonly requestStream = false;
    static readonly responseStream = false;
    static readonly requestType = rpc_pb.FeeReportRequest;
  ...
  export class UpdateChannelPolicy {
    ...
    static readonly requestStream = false;
    static readonly responseStream = false;
    static readonly requestType = rpc_pb.PolicyUpdateRequest;
    static readonly responseType = rpc_pb.PolicyUpdateResponse;
  }
}
